  ...
  return (
    <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
      ...
      <div className="col-span-3">
        ...
        <div className="space-y-8">
          <p>
            Since 1962, The Wild Oasis has stood as a beloved family-owned
            sanctuary. Founded by our grandparents, this haven has flourished
            through generations, reflecting our family's unwavering commitment
            to fostering a warm and inviting atmosphere. Each passing year has
            seen The Wild Oasis lovingly maintained and cherished, a living
            testament to our dedication to hospitality and care.
          </p>
          <p>
